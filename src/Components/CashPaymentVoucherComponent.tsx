...
const CashPaymentVoucherComponent = () => {
  ...
  const cashPaymentVoucherDatas: CashPaymentVoucherDatasInterface[] = [
    {
      id: "1",
      code: "111",
      name: "Food",
  ...
  return (
    <div className="w-full h-full    !overflow-hidden">
      ...
      <div className="">
        ...
        <ListRenderComponent
          cashPaymentVoucherDatas={cashPaymentVoucherDatas}
...
export default CashPaymentVoucherComponent;
