...
const DebtPaymentVoucherComponent = () => {
  ...
  const debtPaymentVoucherDatas: DebtPaymentVoucherDatasInterface[] = [
    {
      id: "1",
      code: "111",
      name: "Food",
  ...
  return (
    <div className="w-full h-full    !overflow-hidden">
      ...
      <div className="">
        ...
        <ListRenderComponent
          debtPaymentVoucherDatas={debtPaymentVoucherDatas}
...
export default DebtPaymentVoucherComponent;
