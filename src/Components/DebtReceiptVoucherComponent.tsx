...
const DebtReceiptVoucherComponent = () => {
  ...
  const debtReceiptVoucherDatas: DebtReceiptVoucherDatasInterface[] = [
    {
      id: "1",
      code: "111",
      name: "Food",
  ...
  return (
    <div className="w-full h-full    !overflow-hidden">
      ...
      <Modal opened={opened} onClose={close} title="Add Debt Receipt" centered>
      ...
      <div className="">
        ...
        <ListRenderComponent
          debtReceiptVoucherDatas={debtReceiptVoucherDatas}
...
export default DebtReceiptVoucherComponent;
